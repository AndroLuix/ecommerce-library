    <div class="card mt-2">
        <div class="card-header d-flex flex-row justify-content-between ">
            <div class="d-flex flex-row justify-content-between ">
                ...
                <h5>Cambia titolo</h5>
                <input required placeholder="name" value="{{ $massive->name }}" 
                type="text" name="name"
                    class="form-control" />
            </div>
                ...
                <form action="{{ route('admin.massive.discount.update', $massive) }}" method="POST"
                    ...
                    <select 
                        ...
                        @foreach ($discounts as $discount)
                            @if ($massive->books[0]->discount_id == $discount->id)
                ...
                <!-- grandezza cards -->
                    <div class="col-3 col-md-4 col-lg-3">
                        <div class="card h-100 shadow-sm">
                             <img src="{{ asset($book->image) }}"  height="200px" class="card-img-top object-fit-scale border rounded"
                                alt="{{$book->name}}">
                            <div class="card-body">
